	...
	<?php 
		if(isset($_GET['id']))
		{
            ...
            redirect('../../../public/view_rez_specijalizacija.php?id='.$go_back_id.''); // idemo nazad
		...
		else 
		{
		    ...
		    while($row = fetch_array($query2)) {
                redirect('../../../public/view_rez_specijalizacija.php?id='.htmlentities($row["spec_id"]).''); // idemo nazad
            }
		}
	?>