        ...
        <div class="page-main">
            ...
            <?php
                ...
                if (!empty($errors)) {
                    ...
                    $query  = "INSERT INTO nerez_subspecijalizacije (";
                    $query .= " spec_id, fak_id, d_id, vs_id, broj_evid_godina, ime_prezime, datum_rodjenja,";
                    ...
                    $query .= ") VALUES (";
                    $query .= "  '{$spec_id}', '{$fakultet}', '{$drzava}', '{$spec}', '{$broj_evid}', '{$ime}', '{$datum_rodjenja}', ";
                    ...
                    {
                        // Success
                        set_message("Subpecijalizacija za nerezidenta je uspješno evidentirana.");
                        redirect("add_nerez_subspecijalizacija.php");
                    } else {
                        // Failure
                        ...
                        <form action="" method="post" class="card bg-blue-lighter" enctype="multipart/form-data">
                            <div class="col-12">                              
                                <div class="card-header">
                                   <h3 class="card-title">Strani državljani | Unos subspecijalizacije</h3>
                                </div>
                                <div class="card-body">
                                    <div class="row">                                   
