            ...
            <div class="container">
                ...
                ?>
                    ...
                    <div class="btn-list text-right mb-2 mr-3" style="margin-top:-60px;">                  
                        <a href="add_rez_specijalizacija.php" class="btn btn-indigo btn-lg"><i class="fa fa-plus"></i> &nbsp;&nbsp;Dodaj specijalizaciju</a>
                    </div> 
