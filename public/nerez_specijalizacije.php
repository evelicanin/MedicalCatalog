            ...
            <div class="container">
                ...
                ?>
                    ...
                    <div class="page-header">
                        <h1 class="page-title">Specijalizacije stranih državljana</h1>                       
                    </div>  
                                     
                    <div class="btn-list text-right mb-2 mr-3" style="margin-top:-60px;">                  
                        <a href="add_nerez_specijalizacija.php" class="btn btn-indigo btn-lg"><i class="fa fa-plus"></i> &nbsp;&nbsp;Dodaj specijalizaciju</a>
                    </div> 
                        ...
                        <table class="table card-table table-vcenter">
                          <thead>
                            <tr>
                              ...
                              <th>Dodaj subspecijalizaciju</th>
                              <th class="text-right">Pregled / Izmjena / Brisanje</th>
                            </tr>
                          </thead>
                          <tbody>
                                <?php lista_nerez_specijalizacija();?>
                          </tbody>                            
                        </table>
                    </div>
                </div>            
