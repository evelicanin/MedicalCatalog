        ...
        <div class="page-main">
            ...
            <div class="my-3 my-md-5">
                <div class="container">
	                ...
	                <?php add_vrsta_subspecijalizacije(); ?>      
                    
                    <div class="page-header">                
                      <h1 class="page-title">
                        Tipovi subspecijalizacija
                      </h1>                  
                    </div>
                    ...
                    <div class="row row-cards row-deck">
                        <div class="col-12">
                            <form class="card" action="" method="post">
                                <div class="card-body">
                                  <h3 class="card-title">Dodavanje vrste subspecijalizacije u šifarnik</h3>
                                  <div class="row">
                                ...
                                <div class="card-footer text-right">
                                  <button type="submit" name="add_vrsta_subspecijalizacije" class="btn btn-primary"><i class="fe fe-database"></i> Spasi</button>
                                </div>
                            </form>                    
                        </div>
                    </div>
