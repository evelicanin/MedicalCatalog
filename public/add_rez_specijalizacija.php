        ...
        <div class="page-main">
            ...
            <?php
                ...
                if (!empty($errors)) {
                    ...
                    $query  = "INSERT INTO rez_specijalizacije (";
                    $query .= " fak_id, u_id, l_id, d_id, vs_id, broj_evid_godina, ime_prezime, jmbg, adresa,";
                    ...
                    $query .= ") VALUES (";
                    $query .= "  '{$fakultet}', '{$ustanova}', '{$jezik}', '{$drzava}', '{$spec}', '{$broj_evid}', '{$ime}', '{$jmbg}', '{$adresa}',";
                    ...
                    {
                        // Success
                        set_message("Specijalizacija je uspješno evidentirana.");
                        redirect("add_rez_specijalizacija.php");
                    } else {
                        // Failure
                        ...
                        <form action="" method="post" class="card" enctype="multipart/form-data">
                            <div class="col-12">                              
                                <div class="card-header">
                                   <h3 class="card-title">Unos specijalizacije državljana BiH</h3>
                                </div>
                                <div class="card-body">
                                    <div class="row">                                   
