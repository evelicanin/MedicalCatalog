            ...
            <?php include(TEMPLATE_FRONT . DS . "top_nav.php"); ?> 
                ...
                <?php if(isset($_GET['id'])) 
                    {
                        ...
                        $query = query("SELECT * FROM rez_subspecijalizacije WHERE subspec_id = " . escape_string($_GET['id']) . " ");
                        confirm($query);
                        while($row = fetch_array($query))
                        {
                                                
                            $specijal         = escape_string($row['spec_id']);                         
                ...
                <div class="my-3 my-md-5">
                    <div class="container">
                        ...
                        <div class="page-header">
                          <h1 class="page-title">
                            <?php echo 'Subspecijalizacija broj : <b>' . $broj_evid . '</b>'; ?>
                          </h1>
                        </div>

                        <div class="btn-list text-right mb-2 mr-3" style="margin-top:-60px;">   
                        <a href="print_subspec.php?id=<?php echo $subspec_id; ?>" target="_blank" class="btn btn-lg btn-secondary"><i class="fe fe-printer"></i> Printaj</a>  
                        <?php    
                            echo '<a class="btn btn-lg btn-cyan" href="edit_rez_subspecijalizacija.php?id='.htmlentities($subspec_id).'">
                ...
                <div class="my-3 my-md-5">
                    <div class="container">
                        ...
                        <div class="btn-list text-right mb-2 mr-3" style="margin-top:-60px;">  
                        <?php    
                            echo '<a class="btn btn-lg btn-indigo" href="add_ustanova_staziranja_sub.php?id='.$subspec_id.'">
                                ...
                                <div class="card">
                                    <div class="table-responsive">
                                        <table class="table card-table table-vcenter text-nowrap">
                                            ...
                                            <tbody>
                                                <?php lista_ustanova_staziranja_sub($subspec_id, 'RSS');?>
                                            </tbody>
                                        </table>                                   
                                    </div>
                                </div>
                        ...
                        {  
                            ...
                            <div class="row row-cards row-deck">
                                <div class="col-12">
                                    ...
                                    href="../resources/templates/back/delete_rez_subspec_image.php?id='.htmlentities($subspec_id).'">
