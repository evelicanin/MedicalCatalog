    ...
    <div class="page"> <!-- zatvoren div u footer.php -->
        ...
        <div class="page-main">
            ...
            <?php if(isset($_GET['id'])) 
            {
                ...
                {
                    $subpec_id = escape_string($row2['spec_id']);
                }                
            } 
            ?>            
            <?php if (isset($_POST['add_uplata'])) 
            {
                ...
                if (!empty($errors)) {
                    ...
                    redirect('ustanove_uplate.php?id='.$us_id.'');
                }               

                // insert u tabelu taskova
                $query  = "INSERT INTO ustanove_uplate (";
                ...
                if ($result)
                {
                    ...
                    redirect('ustanove_uplate_sub.php?id='.$us_id.'');
                } else {
                    // Failure
            ...
            ?>      
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">Subspecijalizacije BiH državljana | Uplate ustanove</h1>                       
                        </div>  
                                         
                        <div class="btn-list text-right mb-2 mr-3" style="margin-top:-60px;">                  
                            <?php    
                                echo '<a class="btn btn-lg btn-secondary" href="view_rez_subspecijalizacija.php?id='. $subpec_id .'">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3 col-md-3">
                                                <div class="text-right mt-5">
                                                    <button type="submit" name="add_uplata" class="btn btn-primary btn-block"><i class="fe fe-database"></i> Spasi</button>
                                                </div>
                                            </div>                                   
                                        </div>
                                    </div>
