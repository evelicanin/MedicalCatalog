            ...
            <div class="my-3 my-md-5">
                <div class="container">
	                ...
	                <?php // add_zdravstvena_ustanova(); 
                        if(isset($_POST['add_zdravstvena_ustanova_nerez'])) 
                        {
                            ...
                            if(isset($_GET['id'])) 
                            {
                                ...
                                $insert_user = query("INSERT INTO ustanove_staz_nerez(spec_id, u_id, iznos, period_staza, oznaka, user_unio) VALUES ('{$spec_id}', '{$ustanova}', '{$iznos}', '{$period}', 'NSS', '{$user_unio}') ");
                                confirm($insert_user);
                    ...
                    <div class="page-header">                
                      <h1 class="page-title">
                        Strani državljani | Dodavanje zdravstvenih ustanova u kojima se obavlja subspecijalizacija
                      </h1>                  
                    </div>
                    <div class="btn-list text-right mb-2 mr-3" style="margin-top:-60px;">                  
                        <?php    
                            echo '<a class="btn btn-lg btn-secondary" href="view_nerez_subspecijalizacija.php?id='. $_GET['id'] .'">
