            ...
            <?php include(TEMPLATE_FRONT . DS . "top_nav.php"); ?> 
                ...
                <div class="my-3 my-md-5">
                    <div class="container">
                        ...
                        <a href="print_spec.php?id=<?php echo $spec_id; ?>" target="_blank" class="btn btn-lg btn-secondary"><i class="fe fe-printer"></i> Printaj</a>  
                        <?php    
                            echo '<a class="btn btn-lg btn-cyan" href="edit_rez_specijalizacija.php?id='.htmlentities($spec_id).'">
                ...
                <div class="my-3 my-md-5">
                    <div class="container">
                        ...
                        <div class="btn-list text-right mb-2 mr-3" style="margin-top:-60px;">                       
                        <?php
                            echo '<a class="btn btn-lg btn-indigo" href="add_ustanova_staziranja.php?id='.$spec_id.'">
                                ...
                                <div class="card">
                                    <div class="table-responsive">
                                        <table class="table card-table table-vcenter text-nowrap">
                                            ...
                                            <tbody>
                                                <?php lista_ustanova_staziranja($spec_id, 'RS');?>
                                            </tbody>
                                        </table>                                   
                                    </div>
                                </div>
                        ...
                        {  
                            ...
                            <div class="row row-cards row-deck">
                                <div class="col-12">
                                    ...
                                    href="../resources/templates/back/delete_rez_spec_image.php?id='.htmlentities($spec_id).'">
