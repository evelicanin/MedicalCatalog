...
<?php user_is_logged();?> <!-- ako user nije logovan, vrati ga nazad na login -->
	...
	<?php 
		...
		if(isset($_GET['id'])) 
		{
			...
			$query = query("SELECT * FROM vrste_subspecijalizacija WHERE vss_id = " . escape_string($_GET['id']) . " ");
			confirm($query);

			while($row = fetch_array($query))
			{
				$vss_id       = escape_string($row['vss_id']);
				$vss_title    = escape_string($row['vss_title']);		 
			}
		}
                ...
                <div class="container">
                    ...
                    <div class="row row-cards row-deck">
                        <div class="col-12">
                                  ...
                                  <div class="row">
                                    <div class="col-sm-12 col-md-12">
                                      <div class="form-group">
                                        ...
                                        <input type="text" name="naziv" class="form-control" placeholder="Naziv" value="<?php echo $vss_title; ?>">
                                      </div>
                                    </div>
                                  </div>
                                </div>
                            ...
                            <?php update_vrsta_subspecijalizacije();  ?>
