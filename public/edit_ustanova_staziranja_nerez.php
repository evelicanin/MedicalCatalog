            ...
            <div class="my-3 my-md-5">
                <div class="container">
                    ...
                    <div class="page-header">                
                      <h1 class="page-title">
                        Strani državljani | Izmjena zdravstvene ustanove u kojima se obavlja specijalizacija
                      </h1>                  
                    </div>
                    <div class="btn-list text-right mb-2 mr-3" style="margin-top:-60px;">                  
                        <?php    
                            echo '<a class="btn btn-lg btn-cyan" href="view_nerez_specijalizacija.php?id='. $specid .'">
                        ...
                        <div class="col-12">
                            <form class="card" action="" method="post">
                                ...
                                <div class="card-footer text-right">
                                  <button type="submit" name="update_zdravstvena_ustanova_nerez" class="btn btn-primary"><i class="fe fe-database"></i> Spasi</button>
                                </div>
                            </form>  
