            ...
            ?>      
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">Specijalizacije BiH državljana | Uplate ustanove</h1>                       
                        </div>  
                                         
                        <div class="btn-list text-right mb-2 mr-3" style="margin-top:-60px;">                  
                            <?php    
                                echo '<a class="btn btn-lg btn-secondary" href="view_rez_specijalizacija.php?id='. $spec_id .'">
