            ...
            <div class="container">
                ...
                ?>
                    ...
                    <div class="page-header">
                        <h1 class="page-title">Subspecijalizacije državljana BiH</h1>                       
                    </div>  
                            
                    <!--                            
                    <div class="btn-list text-right mb-2 mr-3" style="margin-top:-60px;">                  
                        <a href="add_rez_subspecijalizacija.php" class="btn btn-indigo btn-lg"><i class="fa fa-plus"></i> &nbsp;&nbsp;Dodaj subspecijalizaciju</a>
                    </div> 
                    -->
                    ...
                    <div class="card">
                        <table class="table card-table table-vcenter text-nowrap">
                          ...
                          <tbody>
                                <?php lista_bh_subspecijalizacija();?>
                          </tbody>                            
