                    ...
                    <div class="row row-cards row-deck">
                        <div class="col-12">
                            <form class="card" action="" method="post">
                                <div class="card-body">
                                  <h3 class="card-title">Dodavanje stranog jezika u šifarnik</h3>
                                  <div class="row">
                                    <div class="col-sm-12 col-md-12">
                                      <div class="form-group">
                                        <label class="form-label">Naziv stranog jezika</label>
                                ...
                                <div class="card-footer text-right">
                                  <button type="submit" name="add_strani_jezik" class="btn btn-primary"><i class="fe fe-database"></i> Spasi</button>
                                </div>
                            </form>                    
                        </div>
                    </div>
