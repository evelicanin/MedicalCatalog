...
<?php $ustanove_set = select_ustanova();?>
	...
	<?php 
		...
		if(isset($_GET['id'])) 
		{
            $query = query("SELECT us.us_id as id,us.spec_id as specid, u.u_id as ustanova_id, u.u_title as title, us.period_staza as period, us.iznos as iznos FROM ustanove_staz_nerez us, ustanove u WHERE us.u_id = u.u_id AND us.us_id =". escape_string($_GET['id']) ." ");			
            confirm($query);
            ...
            <div class="my-3 my-md-5">
                <div class="container">
                    ...
                    <div class="page-header">                
                      <h1 class="page-title">
                        Strani državljani | Izmjena zdravstvene ustanove u kojima se obavlja subspecijalizacija
                      </h1>                  
                    </div>
                    <div class="btn-list text-right mb-2 mr-3" style="margin-top:-60px;">                  
                        <?php    
                            echo '<a class="btn btn-lg btn-cyan" href="view_nerez_subspecijalizacija.php?id='. $specid .'">
                        ...
                        <div class="col-12">
                            <form class="card" action="" method="post">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-sm-4 col-md-4">
                                      <div class="form-group">
                                        ...
                                        <input value="<?php echo $period; ?>" type="text" name="period" class="form-control" placeholder="Period trajanja staža">
                                      </div>
                                    </div>
                                    <div class="col-sm-4 col-md-4">
                                      <div class="form-group">
                                ...
                                <div class="card-footer text-right">
                                  <button type="submit" name="update_zdravstvena_ustanova_nerez_sub" class="btn btn-primary"><i class="fe fe-database"></i> Spasi</button>
                                </div>
                            </form>  
                            
                            <?php update_zdravstvena_ustanova_nerez();  ?>     
                            <!-- ovdje name buttona iznad odredjuje koji IF ce u funkciji da se izvrsi -->
