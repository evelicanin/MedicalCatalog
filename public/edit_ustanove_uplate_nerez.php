            ...
            <div class="my-3 my-md-5">
                <div class="container">
                    ...
                    <?php 
                        ...
                        if(isset($_GET['id'])) 
                        {
                            $query = query("SELECT * FROM ustanove_uplate_nerez WHERE upl_id = " . escape_string($_GET['id']) . " ");
                            confirm($query);
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">Specijalizacije stranih državljana | Izmjena uplate</h1>                       
                        </div>  
                                         
                        <div class="btn-list text-right mb-2 mr-3" style="margin-top:-60px;">                  
                            <?php    
                                echo '<a class="btn btn-lg btn-secondary" href="view_nerez_specijalizacija.php?id='. $spec_id .'">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3 col-md-3">
                                                <div class="text-right mt-5">
                                                    <button type="submit" name="update_uplata_nerez" class="btn btn-primary btn-block"><i class="fe fe-database"></i> Spasi</button>
                                                </div>
                                            </div>                                   
                                        </div>
                                    </div>
