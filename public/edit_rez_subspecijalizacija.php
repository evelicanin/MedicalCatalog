            ...
            <div class="my-3 my-md-5">
                <div class="container">
                    ...
                    <div class="row">
                        <form action="" method="post" class="card bg-blue-lighter" enctype="multipart/form-data">
                            <div class="col-12">                              
                                <div class="card-header">
                                   <h3 class="card-title">Izmjena subspecijalizacije broj : <b> <?php echo $broj_evid; ?> </b></h3>
                                </div>
                                <div class="card-body">
                                    <div class="row">                                   
                                ...
                                <div class="col-12">                              
                                    ...
                                    <div class="card-footer text-right">
                                        <div class="d-flex">
                                          <button type="submit"  id="submit" name="update_rez_subspecijalizacija" class="btn btn-primary ml-auto"><i class="fa fa-database"></i> Spasi</button>                                      
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <?php update_rez_subspecijalizacija();  ?>
